...
//    outputFileName.append(".csv");
    ...
    fw.modify("OutputModule::filter","diMuPtRec>300 && numberOfRecMuons==2 && muEtaRec[0]<2.1 && muEtaRec[0]>-2.1 && muPtRec[0]>40 && muEtaRec[1]<2.1 && muEtaRec[1]>-2.1 && muPtRec[1]>40");
    fw.modify("OutputModule::output",outputFileName.c_str());
    fw.modify("OutputModule::leaflist","event/I:entry/I:numberOfJets/I:m3jets/D:met/D:jetPtRec[4]/D:ZpT/D:numberOfRecMuons/I:diMuPtRec/D:muPtRec[4]/D:muEtaRec[4]/D:muPfIso[4]/D:numberOfGenMuons/I:diMuPtGen/D");
    fw.beginJob();
    fw.process(-1);
    fw.endJob();
