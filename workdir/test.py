...
fw.modify("OutputModule::filter","met>350 && numberOfRecMuons==0 && numberOfRecElectrons==0"); #&& muEtaRec[0]<2.1 && muEtaRec[0]>-2.1 && muPtRec[0]>40 && muEtaRec[1]<2.1 && muEtaRec[1]>-2.1 && muPtRec[1]>40
fw.modify("OutputModule::output","qwe");
fw.modify("OutputModule::leaflist","event/I:entry/I:pfmet170/I:numberOfJets/I:m3jets/D:met/D:jetPtRec[4]/D:numberOfRecMuons/I:numberOfRecElectrons/I");
fw.beginJob();
fw.process(10000);
fw.endJob();
