...
fw.modList();
fw.modify("InputModule::path","/tmp/kkotov/SingleMu_Pt1To1000_FlatRandomOneOverPt_plusRPC.root");
fw.modify("InputModule::showProgressPeriod","1000");
fw.modify("InputModule::firstEntry","0");
fw.modify("OutputModule::filter","1 && 1");
fw.modify("OutputModule::output","SingleMu_Pt1To1000_FlatRandomOneOverPt_plusRPC_2.csv");
fw.modify("OutputModule::leaflist",
"entry/I:muPtGen/D:muEtaGen/D:muPhiGen/D:\
numberOfEMTFTracks/I:pt[2]/D:mypt[2]/D:ptGMT[2]/I:mode[2]/I:theta_i[2]/I:\
